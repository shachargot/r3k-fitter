...
SAMPLES = {
    ...
    'kstar_jpsi_kaon': {
        ...
        'bf_chain': BR_B_PLUS_JPSI_KSTAR * BR_JPSI_EE,
        'n_gen': 100000000,
        'analysis_axe': 0.0,
    },
    'kstar_jpsi_pion': {
    ...
    'kstar_psi2s_kaon': {
        ...
        'bf_chain': BR_B_PLUS_PSI2S_KSTAR * BR_PSI2S_EE,
        'n_gen': 100000000,
        'analysis_axe': 0.0,
    },
    'kstar_psi2s_pion': {
    ...
    'kstar_kaon': {
        ...
        'label': 'B^{+} #rightarrow K^{*+} e^{+} e^{-} (K^{+}#pi^{0})',
        'xs_prod': SIGMA_BB,
        # 'bf_chain': BR_B_PLUS_KSTAR_EE * BR_KSTAR_PLUS_KPI0,
        'bf_chain': BR_B_PLUS_KSTAR_EE,
        'n_gen': 100000000,
        'analysis_axe': 0.0,
    },
    'kstar_pion': {
        'file_key': 'kstar_pion_file',
        'label': 'B^{+} #rightarrow K^{*+} e^{+} e^{-} (K^{0}#pi^{+})',
        'xs_prod': SIGMA_BB,
